...
#SHOWS THE PLOTTED LAP TIMES FOR RUSSELL IN MONTREAL 2026, GROUPED BY TIRE COMPOUND
df = pd.read_csv("cleaned_russell_montreal_2026.csv")
...
plt.title("Lap Time vs Lap Number by Tire Compound - Russell Montreal 2026")
plt.legend()
plt.grid(True)
plt.show()